...
public class BookingController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> processBooking(@RequestBody WaitingListEntity waitingRequest) { // ? có nghĩa là có thể là Booking hoặc WaitingList
        Object result = bookingService.createBookingOrWaiting(waitingRequest); // Trả về một result có thể là Booking hoặc WaitingList
